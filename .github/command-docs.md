...
| .createwallet | Creates a virtual wallet to play mini-games with    | .create <br/> .cw |
| .claimall     | Claim rewards to add to your wallet balance         | .claim <br/> .ca  |
| .balance      | Check wallet balance                                | .bal <br/> .b     |
