...
| .runsimplecommand | Runs a simple command created by the Moderators. These are temporary commands for simple messages.             | .sc <br/> .rsc                        |
...
| .simplecommand  | Manage simple commands that can be easily added and removed for temporary situations   | .simplecommands                          |
| .timeout        | ---                                                                                    | ---                                      |
| .unban          | ---                                                                                    | ---                                      |
