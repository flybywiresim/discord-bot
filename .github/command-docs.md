...
| .runtemporarycommand | Runs a temporary command created by the Moderators and can list them. These are temporary commands for simple messages. | .runtempcommand <br> .st <br> .rtc    |
...
| .temporarycommands | Manage temporary commands, which are simple output commands to highlight temporary situations to users. | .temporarycommand <br> .tempcommands <br> .tempcommand |
| .timeout           | ---                                                                                                     | ---                                                    |
| .unban             | ---                                                                                                     | ---                                                    |
