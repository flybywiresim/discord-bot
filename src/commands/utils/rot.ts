        ...
        if (altitude <= 1000 && text.startsWith('FL')) {
            ...
            const todFlightLevelEmbed = makeEmbed({
                ...
                description: makeLines([
                    ...
                    '',
                    'This is an approximation of your TOD using the rule of three. See the official [guide](https://docs.flybywiresim.com/pilots-corner/beginner-guide/descent/#how-to-calculate-the-required-distance-for-descent) for planning an optimal descent.',
                ]),
            });
