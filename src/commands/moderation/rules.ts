...
const ROLE_EMBED = [
    makeEmbed({
        ...
        description: 'We want as many people to use their vast experience and knowledge to help us create a highly detailed mod for the A320N. If you have skills in Documentation, Modelling and/or Programming, please assign your <#759405708994281493> and get started with the conversation to develop the mod, verification of these roles will be required to access the organiser.',
    }),
];
