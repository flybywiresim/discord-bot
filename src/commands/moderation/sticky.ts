...
const stickyMessageEmbedField = (date: string, moderator: string, message: string, timeInterval: string, messageCount: string, channel: string): EmbedField[] => [
    {
        inline: true,
        name: 'Channel',
        value: `<#${channel}>`,
...
export const sticky: CommandDefinition = {
    ...
    executor: async (msg) => {
        ...
        if (subCommand === 'set') {
            ...
            try {
                modLogsChannel.send({ embeds: [channelEmbed('Set', stickyMessageEmbedField(moment(stickyMessage.date).utcOffset(0).format('YYYY-MM-DD HH:mm:ss'), stickyMessage.moderator, stickyMessage.message, `${stickyMessage.timeInterval}`, `${stickyMessage.messageCount}`, stickyMessage.channelId), Colors.Green)] });
            } catch {
        ...
        if (subCommand === 'count') {
            ...
            try {
                modLogsChannel.send({ embeds: [channelEmbed('Configure minimum message count', stickyMessageEmbedField(moment(stickyMessage.date).utcOffset(0).format('YYYY-MM-DD HH:mm:ss'), stickyMessage.moderator, stickyMessage.message, `${stickyMessage.timeInterval}`, `${stickyMessage.messageCount}`, stickyMessage.channelId), Colors.Green)] });
            } catch {
        ...
        if (subCommand === 'unset') {
            ...
            try {
                modLogsChannel.send({ embeds: [channelEmbed('Delete', stickyMessageEmbedField(moment(stickyMessage.date).utcOffset(0).format('YYYY-MM-DD HH:mm:ss'), stickyMessage.moderator, stickyMessage.message, `${stickyMessage.timeInterval}`, `${stickyMessage.messageCount}`, stickyMessage.channelId), Colors.Red)] });
            } catch {
        ...
        if (subCommand === 'info') {
            ...
            return msg.channel.send({ embeds: [infoEmbed(stickyMessageEmbedField(moment(stickyMessage.date).utcOffset(0).format('YYYY-MM-DD HH:mm:ss'), stickyMessage.moderator, stickyMessage.message, `${stickyMessage.timeInterval}`, `${stickyMessage.messageCount}`, stickyMessage.channelId))] });
        }
