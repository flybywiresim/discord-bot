    ...
    fields: [
        {
            ...
            value: makeLines([
                ...
                'Example:',
                `\`${evokedCommand} add exp-bad-build warn "Experimental build broken" "The Experimental build is broken and the displays do not light up. A fix is being actively developed."\``,
                '\u200B',
            ]),
            inline: false,
        },
