    ...
    executor: (msg) => msg.channel.send(makeEmbed({
        ...
        fields: [
                        ...
                        },
                        {
                            ...
                            value: "> **The mod is an improvement of the default,** so there isn't a second A320 model with the mod installed.\n ",
                        },
                        {
                            name: `What are the liveries available?`,
                            value: "> All liveries work with the A32NX mod, we recommend downloading your liveries from: https://flightsim.to\n ",
                        },
                        {
