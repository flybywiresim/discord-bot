...
const remoteEfbEmbed = makeEmbed({
    ...
    description: makeLines([
        ...
        '',
        'In the meantime, you can, however, use an application such as [spacedesk](https://www.spacedesk.net/)* to create a virtual screen using your tablet/phone/PC, and detach the EFB from MSFS by holding the `ALTGR` button and clicking on the EFB with your mouse. You can then drag the EFB window to your virtual screen.',
        '',
