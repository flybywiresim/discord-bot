...
const devLanguagesEmbed = makeEmbed({
    ...
    description: makeLines([
        'The A32NX is built using a number of development languages for different aspects of the aircraft. The list below confirms the current languages used, however is not exhaustive.',
        '',
        '**General:** React',
