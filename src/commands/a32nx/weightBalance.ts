...
export const weightBalance: CommandDefinition = {
    ...
    executor: (msg) => msg.channel.send(makeEmbed({
        ...
        description: makeLines(['We have recently improved the A32NX flight model and finalized our weight and balance loading integration available on the development version. Please note:',
            ,
