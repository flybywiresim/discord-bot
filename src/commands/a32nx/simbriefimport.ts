    ...
    executor: async (msg) => {
        const simbriefImportEmbed = makeEmbed({
            ...
            description: makeLines([
                'The A32NX has simBrief integration. This means you can create a flight plan in simBrief and import it into the FMS. Please refer to our [documentation](https://docs.flybywiresim.com/fbw-a32nx/feature-guides/simbrief/) for instructions.',
            ]),
        });
