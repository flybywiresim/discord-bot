...
export const weather: CommandDefinition = {
    ...
    executor: (msg) => msg.channel.send(makeEmbed({
        ...
        description: makeLines(['The development and experimental versions of the A32NX does not have operating weather and terrain radars. This is due to the performance issues related to the default weather and terrain radars and the ND being rewritten.',
        ,
